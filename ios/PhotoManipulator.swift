...
class PhotoManipulator: NSObject {
    static let defaultQuality = CGFloat(100)

    public class func batch() {
    
    }
    
    public class func crop() {
    
    }
    
    public class func flipImage() {
    
    }
    
    public class func rotateImage() {
    
    }
    
    public class func overlayImage() {
    
    }
    
    public class func printText() {
